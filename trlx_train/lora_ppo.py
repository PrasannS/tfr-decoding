...
class ScriptArguments:
    ...
    model_name: Optional[str] = field(
        default="/home/prasann/Projects/tfr-decoding/apfarm_models/sft10k", metadata={"help": "the model name"}
    )
...
# TODO removed gpt-neox specific cstuff 
...
for epoch, batch in tqdm(enumerate(ppo_trainer.dataloader)):
    ...
    for query in query_tensors:
        ...
        response = ppo_trainer.generate(query.to(ppo_trainer.accelerator.device), **generation_kwargs)
